...
<div class="toast-container position-fixed bottom-0 end-0 mb-2 p-3">
  <div id="welcomeToast" class="toast shadow-sm" role="alert" aria-live="assertive" aria-atomic="true">
    ...
    <div class="container-fluid" style="padding: 15rem 22rem;">
        ...
        <marquee class="text-light mb-5"><span class="badge bg-danger me-2"><i class="bi bi-megaphone-fill"></i> ประกาศ</span>ยังไม่เสร็จไอ้สัส !!</marquee>
        <div class="row">
            <div class="col">
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100 rounded-4" src="./assets/img/2.png" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100 rounded-4" src="./assets/img/3.png" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100 rounded-4" src="./assets/img/4.jpg" alt="Third slide">
                        </div>
                    </div>
