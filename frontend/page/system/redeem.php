...
<body>
    ...
    <div class="container" style="margin-top: 150px; margin-bottom: 200px;">
        <div class="row justify-content-center align-items-center mt-3">
            <div class="col-md-10">
                <h2 class="h1 text-primary fw-bold"><i class="bi bi-database-fill-up"></i> REDEEM (เติมโค้ด)</h2>
                <hr class="text-primary">
                <h3 class="h4 text-light"><i class="bi bi-gift-fill"></i> กรอกโค้ดเพื่อรับรางวัลจากเรา</h3>
            <div class="d-flex justify-content-center">
                <img src="frontend/assets/icon/unboxing.png" class="img-fluid" width="400px" height="auto"  alt="Topup Image">
            </div>
            <div class="form-floating">
                <input type="text" name="topup" class="form-control custom-input" placeholder="topup">
